Repository of the Materials and Methods used to analyse the data corresponding to the cell proportion experiments, gastruloid morphogenesis, fusion experiments and nanoindentation in the manuscript:   
