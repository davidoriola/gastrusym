...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 22 15:58:21 2025
...
data_GFP_24_XAV_220705=data_GFP_24_XAV_220705.sort_values(by=['GFP fraction'])
data_GFP_24_XAV_220712=data_GFP_24_XAV_220712.sort_values(by=['GFP fraction'])

data_GFP_48_XAV_220706=data_GFP_48_XAV_220706.sort_values(by=['GFP fraction'])
data_GFP_48_XAV_220713=data_GFP_48_XAV_220713.sort_values(by=['GFP fraction'])

data_GFP_72_XAV_220707 =data_GFP_72_XAV_220707.sort_values(by=['GFP fraction'])
data_GFP_72_XAV_220714=data_GFP_72_XAV_220714.sort_values(by=['GFP fraction'])

# Extrapolate maximum GFP value for normalization 

popt_220705,pcov_220705 = curve_fit(linear_fit,np.array([0.0,0.2,0.5,0.8]),data_GFP_24_XAV_220705[data_GFP_24_XAV_220705['Condition']=='24h XAV']['GFP fluo'][0:4])
popt_220712,pcov_220712 = curve_fit(linear_fit,np.array([0.0,0.2,0.5,0.8]),data_GFP_24_XAV_220712[data_GFP_24_XAV_220712['Condition']=='24h XAV']['GFP fluo'][0:4])

# I normalise by the intensity

data_GFP_24_XAV_220705['GFP fluo norm']=data_GFP_24_XAV_220705['GFP fluo']/popt_220705
data_GFP_48_XAV_220706['GFP fluo norm']=data_GFP_48_XAV_220706['GFP fluo']/popt_220705
data_GFP_72_XAV_220707['GFP fluo norm']=data_GFP_72_XAV_220707['GFP fluo']/popt_220705

data_GFP_24_XAV_220712['GFP fluo norm']=data_GFP_24_XAV_220712['GFP fluo']/popt_220712
data_GFP_48_XAV_220713['GFP fluo norm']=data_GFP_48_XAV_220713['GFP fluo']/popt_220712
data_GFP_72_XAV_220714['GFP fluo norm']=data_GFP_72_XAV_220714['GFP fluo']/popt_220712

# Compile data

data_GFP_24h=pd.concat([data_GFP_24_XAV_220705, data_GFP_24_XAV_220712]) 
data_GFP_48h=pd.concat([data_GFP_48_XAV_220706, data_GFP_48_XAV_220713]) 
data_GFP_72h=pd.concat([data_GFP_72_XAV_220707, data_GFP_72_XAV_220714]) 
...
data_GFP_24h_PDO3 = data_GFP_24h[data_GFP_24h['Condition']=='24h XAV'] 
data_GFP_48h_PDO3 = data_GFP_48h[data_GFP_48h['Condition']=='48h XAV']  
data_GFP_72h_PDO3 = data_GFP_72h[data_GFP_72h['Condition']=='72h XAV'] 
...
plt.show()
s2fig.savefig('T_dynamics_250304_XAV.pdf',bbox_inches = "tight")   # save as .eps
...
#plt.show()
#modelfig.savefig('modelfig_240131_PDO3_new.pdf',bbox_inches = "tight")   # save as .eps
...
output_fit_XAV = pd.DataFrame({'p':[p,error_p],'q':[q,error_q],'K':[fittedParameters[1],error[1]],'T24(h)':[timescale*fittedParameters[2],timescale*error[2]],'T48(h)':[timescale*fittedParameters[3],timescale*error[3]]})
