...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 22 15:19:35 2025
...
plt.show()
s2fig.savefig('T_dynamics_250924_PDO3.pdf',bbox_inches = "tight")   # save as .eps
...
plt.show()
modelfig.savefig('modelfig_250924_PDO3.pdf',bbox_inches = "tight")   # save as .eps
...
output_fit_PDO3 = pd.DataFrame({'p':[p,error_p],'q':[q,error_q],'K':[fittedParameters[1],error[1]],'T24(h)':[timescale*fittedParameters[2],timescale*error[2]],'T48(h)':[timescale*fittedParameters[3],timescale*error[3]]})
output_fit_PDO3.to_csv('output_fit_params_PDO3_250403.csv')
