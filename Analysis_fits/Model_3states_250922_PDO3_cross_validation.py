...
plt.show()
s2fig.savefig('T_dynamics_250922_PDO3.pdf',bbox_inches = "tight")   # save as .eps
...
plt.show()
modelfig.savefig('modelfig_250922_PDO3.pdf',bbox_inches = "tight")   # save as .eps
...
output_fit_PDO3.to_csv('output_fit_params_PDO3_250922.csv')
